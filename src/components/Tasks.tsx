...
export const Tasks = () => {
	return (
		<div className="bot-tasks">
			<div className="bot-header bot-tasks_header">
				Какие задачи можно
				<br />
			...
			<div className="column">
				<div className="column-item">
					{/* <img className="column-item_icon" src="/assets/741b82f2/img/bot/tasks-icon-1.png" alt=""/> */}
				...
				<div className="column-item">
					...
					/>
					<div className="column-item_text">
						Загрузка документов, фотографий, быстрое анкетирование (используйте
						при проведении конкурсов, приеме-подаче заявок и&nbsp;т.&nbsp;п.)
					</div>
				</div>
			</div>
			<div className="column">
